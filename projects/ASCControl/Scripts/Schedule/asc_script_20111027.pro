...
function ASC_Script_20111027, info, reset=reset

  COMMON ASC_Script_20111027_Common, block0_flag
  ...
  if (HourUT() gt 4.25) and (HourUT() lt 12.45) then begin  
  ...
  if (HourUT() gt 12.5) or (HourUT() lt 15.5) then begin
