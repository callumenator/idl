...
if n eq 1 or n eq 12 or n eq 23 or n eq 34 or n eq 45 then begin
type='002'
azmth='***'
znth='**'
endif
;if n eq 2 or n eq 13 or n eq 24 or n eq 35 or n eq 46 then begin
; type='001'
; azmth='000'
; znth='30'
;endif
;if n eq 3 or n eq 14 or n eq 25 or n eq 36 or n eq 47 then begin
; type='001'
; azmth='270'
; znth='30'
;endif
;if n eq 4 or n eq 15 or n eq 26 or n eq 37 or n eq 48 then begin
; type='001'
; azmth='180'
; znth='30'
;endif
;if n eq 5 or n eq 16 or n eq 27 or n eq 38 or n eq 49 then begin
; type='001'
; azmth='090'
; znth='30'
;endif
if n eq 2 or n eq 3 or n eq 4 or n eq 5 or n eq 6 or n eq 7 or $
n eq 8 or n eq 9 or n eq 10 or n eq 11 or n eq 13 or n eq 14 or $
n eq 15 or n eq 16 or n eq 17 or n eq 18 or n eq 19 or n eq 20 or $
n eq 21 or n eq 22 or n eq 24 or n eq 25 or n eq 26 or n eq 27 or $
n eq 28 or n eq 29 or n eq 30 or n eq 31 or n eq 32 or n eq 33 or $
n eq 35 or n eq 36 or n eq 37 or n eq 38 or n eq 39 or n eq 40 or $
n eq 41 or n eq 42 or n eq 43 or n eq 44 or n eq 46 or n eq 47 or $
n eq 48 or n eq 49 or n eq 50 or n eq 51 then begin
type='001'
azmth='000'
znth='90'
endif
...
if n eq 1 or n eq 12 or n eq 23 or n eq 34 or n eq 45 then isignew=isig
if n eq 1 or n eq 12 or n eq 23 or n eq 34 or n eq 45 then goto, dontdo
...
window,4,xsize=256,ysize=255,retain=2
tvscl,isignew

n=n+1
if n eq 52 then goto,stupido
