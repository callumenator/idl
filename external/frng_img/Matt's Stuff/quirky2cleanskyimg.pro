...
imagefile='/usr/users/mpkryn/inuvikimagefiles/'+date+'/'+piece+strfile+'.RAW'
cleanfile='/usr/users/mpkryn/inuvikimagefiles/'+date+'/'+piece+strfile+'.cln'
