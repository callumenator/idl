;******************************************************************
PRO icur_help,IAR                          ;HELP LISTING OF CURSOR COMMANDS
...
ENDIF ELSE begin 
   ...
   endelse
if iar lt 2 then begin
   PRINT,'  ;:  GET NEXT RECORD (ESC)          :   GET previous RECORD (ESC)'
   PRINT,'  |:  Toggle KDAT record number      ":  Replace x''d-out data'
   endif
